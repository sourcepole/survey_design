...
class Ui_TransectSurveyDialogBase(object):
    def setupUi(self, TransectSurveyDialogBase):
        ...
        self.gridLayout_3.addWidget(self.mBaselineGroupBox, 2, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.mStrataIdAttributeLabel, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.mStrataIdAttributeComboBox, 1, 1, 1, 1)
        self.gridLayout_3.addWidget(self.mStrataGroupBox, 3, 0, 1, 2)
