...
class Ui_TransectSurveyDialogBase(object):
    def setupUi(self, TransectSurveyDialogBase):
        ...
        self.gridLayout_3.addWidget(self.mCreateSampleButton, 3, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.mBaselineGroupBox, 1, 0, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.mStrataGroupBox, 2, 0, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.mExportCsvButton, 3, 1, 1, 1)
